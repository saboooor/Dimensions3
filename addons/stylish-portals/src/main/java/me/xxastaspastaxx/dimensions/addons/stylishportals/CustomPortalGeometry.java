...
public class CustomPortalGeometry extends PortalGeometry {
  ...
  CustomPortalGeometry(Vector min, Vector max, FrameStyle frameManager) {
    super(min, max);
  ...
  public CustomPortalGeometry getPortal(CustomPortal customPortal, Location loc) {
    ...
    if (!frameManager.isPortalBlock(minLocation.getBlock())
        || !frameManager.isPortalBlock(maxLocation.getBlock())) return null;
    ...
    if (!frameManager.isPortalBlock(minLocation.getBlock())
        || !frameManager.isPortalBlock(maxLocation.getBlock())) {
