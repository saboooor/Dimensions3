...
/**
 * Is used to combine <a
 * href="https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/Orientable.html">Orientable</a>
 * & <a
 * href="https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/Directional.html">Directional</a>
 */
public class AxisOrFace {
   ...
   *
   * @param axisOrFace String value of <a
   *     href="https://hub.spigotmc.org/javadocs/spigot/org/bukkit/Axis.html">Axis</a> or <a
   *     href="https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/BlockData.html">BlockFace</a>
   */
  ...
  public boolean isData(BlockData blockData) {
    ...
    if (isFace()
        && !((Directional) blockData).getFacing().equals(getFace())
        && ((Directional) blockData).getFaces().contains(getFace())) return false;
