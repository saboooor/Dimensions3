...
/**
 * Use static instances of the class to print debug messages to the appropriate debug level set in
 * the config
 */
public class DimensionsDebbuger {
  ...
  /**
   * Use the DimensionsDebbuger instance to print a message in the console for the appropriate
   * debugLevels set in the config
   *
