...
public class CreatePortalOptions {
  ...
  //	public HashMap<Integer, CreateStructureAction> actions = new HashMap<Integer,
  // CreateStructureAction>();

  //	public ArrayList<StructureActivator> activators = new
  // ArrayList<StructureActivator>(Arrays.asList(new StructureActivator[]
  // {StructureActivator.PLAYER_BLOCK_PLACE}));
